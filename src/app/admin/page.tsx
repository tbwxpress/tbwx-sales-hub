        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <div className="flex items-center gap-4 mt-1">
              ...
              <a href="/admin/agents" className="text-xs text-accent hover:text-accent-hover transition-colors inline-flex items-center gap-1">
                <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                Work Mode (experiment)
              </a>
            </div>
          </div>
          <button
        ...
        <div className="mt-8 mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center justify-between gap-2">
                  <h3 className="text-sm font-semibold text-text">Duplicate Leads</h3>
                  <ArrowRight className="w-4 h-4 text-dim group-hover:text-accent group-hover:translate-x-0.5 transition-all shrink-0" />
                </div>
                <p className="text-xs text-dim mt-1 leading-relaxed">Find leads sharing a phone number and merge them into one — reversible, history preserved.</p>
              </div>
            </a>
          </div>
        </div>
